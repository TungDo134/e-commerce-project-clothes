    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-custom mt-250 " data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active ">
                <img src="https://theme.hstatic.net/1000348721/1000449307/14/slideshow_2.jpg?v=609"
                     class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item ">
                <img src="https://theme.hstatic.net/1000348721/1000449307/14/slideshow_1.jpg?v=609"
                     class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item ">
                <img src="https://theme.hstatic.net/1000348721/1000449307/14/slideshow_4.jpg?v=609"
                     class="d-block w-100" alt="...">
            </div>
    ...
    <div class="container py-5 my-2 bg-white">
        <div class="row">
            <div class="col-12 col-md-6 mb-4">
                <a href="product">
                    <img class="hover_banner" style="max-width: 100%; "
                         src="https://theme.hstatic.net/1000348721/1000449307/14/xxx_4.jpg?v=609"
                         alt="CLOTHING BANNER">
                </a>
            </div>
            ...
            <div class="col-12 col-md-6 mb-4">
                <a href="#">
                    <img class="hover_banner" style="max-width: 100%; "
                         src="https://theme.hstatic.net/1000348721/1000449307/14/xxx_5.jpg?v=609"
                         alt="BAGS BANNER">
                </a>
            </div>
        </div>
